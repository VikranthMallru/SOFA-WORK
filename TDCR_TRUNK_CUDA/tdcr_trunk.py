...
# fixingBox=[-1,0,-1,27.5,7,27.5]
def TDCR_trunk(parentNode, name="TDCR_trunk",
         rotation=[0.0, 0.0, 0.0], translation=[0.0, 0.0, 0.0],
         fixingBox=[-1,0,-1,27.5,7,27.5], minForce = -sys.float_info.max, maxForce = sys.float_info.max):
    ...
    soft_body = ElasticMaterialObject(tdcr,
        ...
        youngModulus=60_000,  # Young's modulus in Pascals
        poissonRatio=0.25,
        totalMass=0.03,
    ...
    roi.addObject("BoxROI",
              name="roi",
              box=[10.25,87,13, 15.75,88,14],  # (xMin, yMin, zMin, xMax, yMax, zMax)
              drawBoxes=True,
              doUpdate=True)
    ...
    cable1 = PullingCable(soft_body,
                          "PullingCable_1",
                          pullPointLocation=[1.435,-3,13.25],
                          rotation=rotation,
                          translation=translation,
    ...
    cable2 = PullingCable(soft_body,
                          "PullingCable_2",
                          pullPointLocation=[24.615,-3,13.25],
                          rotation=rotation,
                          translation=translation,
